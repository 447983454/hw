...
FLUID_3D::FLUID_3D(int xRes, int yRes, int zRes, int amplify) :
	_xRes(xRes), _yRes(yRes), _zRes(zRes), _amplify(amplify), _res(0.)
{
  ...
  for (int z = 0; z < _zRes; z++)
	...
	obsSphere = new SPHERE(0.375, 0.5, 0.375, 0.05); // for 4 to 3 domain 
...
void FLUID_3D::advectMacCormack()
{
  ...
  for (int x = 0; x < _totalCells; x++)
	...
	// advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _heatOld, _heat, res); 
...
//////////////////////////////////////////////////////////////////////
// Advect using the semiLagrange method from the Stable Fluids
//////////////////////////////////////////////////////////////////////
void FLUID_3D::advectSemiLagrange()
{
	Vec3Int res = Vec3Int(_xRes,_yRes,_zRes);
  ...
  for (int x = 0; x < _totalCells; x++)
	...
	advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _densityOld, _density, res); 
	advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _heatOld, _heat, res); 
	advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _xVelocityOld, _xVelocity, res);
	advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _yVelocityOld, _yVelocity, res);
	advectFieldSemiLagrange(dt0, _xVelocityOld, _yVelocityOld, _zVelocityOld, _zVelocityOld, _zVelocity, res);
